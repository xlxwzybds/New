...
## XJY multi-mode add
lpm_dynamic_power9 = float(sim.config.get('perf_model/dram/lowpower/lpm_dynamic_power9'))
lpm_dynamic_power8 = float(sim.config.get('perf_model/dram/lowpower/lpm_dynamic_power8'))
lpm_dynamic_power7 = float(sim.config.get('perf_model/dram/lowpower/lpm_dynamic_power7'))
lpm_dynamic_power6 = float(sim.config.get('perf_model/dram/lowpower/lpm_dynamic_power6'))
lpm_dynamic_power5 = float(sim.config.get('perf_model/dram/lowpower/lpm_dynamic_power5'))
## XJY multi-mode add ends 

lpm_dynamic_power = float(sim.config.get('perf_model/dram/lowpower/lpm_dynamic_power'))

lpm_leakage_power9 = float(sim.config.get('perf_model/dram/lowpower/lpm_leakage_power9'))
lpm_leakage_power8 = float(sim.config.get('perf_model/dram/lowpower/lpm_leakage_power8'))
lpm_leakage_power7 = float(sim.config.get('perf_model/dram/lowpower/lpm_leakage_power7'))
lpm_leakage_power6 = float(sim.config.get('perf_model/dram/lowpower/lpm_leakage_power6'))
lpm_leakage_power5 = float(sim.config.get('perf_model/dram/lowpower/lpm_leakage_power5'))
...
class memTherm:
  def setup(self, args):
    ...
    if mem_dtm != 'off': 
      ...
      ## power9 --- 0.9
      stat_write_power9 = 'dram.bank_write_access_counter_power9'       #from sniper C-code
      stat_read_power9 = 'dram.bank_read_access_counter_power9'       #from sniper C-code
      self.stat_name_read_power9 = stat_read_power9
      self.stat_name_write_power9= stat_write_power9
      stat_component_rd_power9, stat_name_read_power9 = stat_read_power9.rsplit('.', 1)
      stat_component_wr_power9, stat_name_write_power9 = stat_write_power9.rsplit('.', 1)
      ## power8 --- 0.8
      stat_write_power8 = 'dram.bank_write_access_counter_power8'       #from sniper C-code
      stat_read_power8 = 'dram.bank_read_access_counter_power8'       #from sniper C-code
      self.stat_name_read_power8 = stat_read_power8
      self.stat_name_write_power8= stat_write_power8
      stat_component_rd_power8, stat_name_read_power8 = stat_read_power8.rsplit('.', 1)
      stat_component_wr_power8, stat_name_write_power8 = stat_write_power8.rsplit('.', 1)
      ## power7 --- 0.7
      stat_write_power7 = 'dram.bank_write_access_counter_power7'       #from sniper C-code
      stat_read_power7 = 'dram.bank_read_access_counter_power7'       #from sniper C-code
      self.stat_name_read_power7 = stat_read_power7
      self.stat_name_write_power7= stat_write_power7
      stat_component_rd_power7, stat_name_read_power7 = stat_read_power7.rsplit('.', 1)
      stat_component_wr_power7, stat_name_write_power7 = stat_write_power7.rsplit('.', 1)
      ## power6 --- 0.6
      stat_write_power6 = 'dram.bank_write_access_counter_power6'       #from sniper C-code
      stat_read_power6 = 'dram.bank_read_access_counter_power6'       #from sniper C-code
      self.stat_name_read_power6 = stat_read_power6
      self.stat_name_write_power6= stat_write_power6
      stat_component_rd_power6, stat_name_read_power6 = stat_read_power6.rsplit('.', 1)
      stat_component_wr_power6, stat_name_write_power6 = stat_write_power6.rsplit('.', 1)
      ## power5 --- 0.5
      stat_write_power5 = 'dram.bank_write_access_counter_power5'       #from sniper C-code
      stat_read_power5 = 'dram.bank_read_access_counter_power5'       #from sniper C-code
      self.stat_name_read_power5 = stat_read_power5
      self.stat_name_write_power5= stat_write_power5
      stat_component_rd_power5, stat_name_read_power5 = stat_read_power5.rsplit('.', 1)
      stat_component_wr_power5, stat_name_write_power5 = stat_write_power5.rsplit('.', 1)
    ...
    if mem_dtm != 'off':
      ...
      ## XJY multi bank-mode add 
       # power9
        'stat_rd_power9': [ self.getStatsGetter(stat_component_rd_power9, bank, stat_name_read_power9) for bank in range(NUM_BANKS) ],
        'stat_wr_power9': [ self.getStatsGetter(stat_component_wr_power9, bank, stat_name_write_power9) for bank in range(NUM_BANKS) ],
       # power8
        'stat_rd_power8': [ self.getStatsGetter(stat_component_rd_power8, bank, stat_name_read_power8) for bank in range(NUM_BANKS) ],
        'stat_wr_power8': [ self.getStatsGetter(stat_component_wr_power8, bank, stat_name_write_power8) for bank in range(NUM_BANKS) ],
       # power7
        'stat_rd_power7': [ self.getStatsGetter(stat_component_rd_power7, bank, stat_name_read_power7) for bank in range(NUM_BANKS) ],
        'stat_wr_power7': [ self.getStatsGetter(stat_component_wr_power7, bank, stat_name_write_power7) for bank in range(NUM_BANKS) ],
        # power6
        'stat_rd_power6': [ self.getStatsGetter(stat_component_rd_power6, bank, stat_name_read_power6) for bank in range(NUM_BANKS) ],
        'stat_wr_power6': [ self.getStatsGetter(stat_component_wr_power6, bank, stat_name_write_power6) for bank in range(NUM_BANKS) ],
        # power5
        'stat_rd_power5': [ self.getStatsGetter(stat_component_rd_power5, bank, stat_name_read_power5) for bank in range(NUM_BANKS) ],
        'stat_wr_power5': [ self.getStatsGetter(stat_component_wr_power5, bank, stat_name_write_power5) for bank in range(NUM_BANKS) ],
      ## XJY multi bank-mode add ends
      }
    else:
      self.stats = {
...
#    print access_rates
  ...
  #    self.fd.write('%u' % (time / 1e6)) # Time in ns
      ...
      ## power9
      if self.isTerminal:
        self.fd.write('[STAT:%s] ' % self.stat_name_read_power9)
      access_rates_read_power9 = [0 for number in xrange(NUM_BANKS)]
      for bank in range(NUM_BANKS):
        statdiff_rd_power9 = self.stats['stat_rd_power9'][bank].last
        access_rates_read_power9[bank] = statdiff_rd_power9
        self.fd.write(' %u' % statdiff_rd_power9)
      self.fd.write('\n')

      if self.isTerminal:
        self.fd.write('[STAT:%s] ' % self.stat_name_write_power9)
      access_rates_write_power9 = [0 for number in xrange(NUM_BANKS)]
      for bank in range(NUM_BANKS):
        statdiff_wr_power9 = self.stats['stat_wr_power9'][bank].last
        access_rates_write_power9[bank] = statdiff_wr_power9
        self.fd.write(' %u' % statdiff_wr_power9)
      self.fd.write('\n')
      ## 
      ## power8
      if self.isTerminal:
        self.fd.write('[STAT:%s] ' % self.stat_name_read_power8)
      access_rates_read_power8 = [0 for number in xrange(NUM_BANKS)]
      for bank in range(NUM_BANKS):
        statdiff_rd_power8 = self.stats['stat_rd_power8'][bank].last
        access_rates_read_power8[bank] = statdiff_rd_power8
        self.fd.write(' %u' % statdiff_rd_power8)
      self.fd.write('\n')

      if self.isTerminal:
        self.fd.write('[STAT:%s] ' % self.stat_name_write_power8)
      access_rates_write_power8 = [0 for number in xrange(NUM_BANKS)]
      for bank in range(NUM_BANKS):
        statdiff_wr_power8 = self.stats['stat_wr_power8'][bank].last
        access_rates_write_power8[bank] = statdiff_wr_power8
        self.fd.write(' %u' % statdiff_wr_power8)
      self.fd.write('\n')
      ##
      ## power7
      if self.isTerminal:
        self.fd.write('[STAT:%s] ' % self.stat_name_read_power7)
      access_rates_read_power7 = [0 for number in xrange(NUM_BANKS)]
      for bank in range(NUM_BANKS):
        statdiff_rd_power7 = self.stats['stat_rd_power7'][bank].last
        access_rates_read_power7[bank] = statdiff_rd_power7
        self.fd.write(' %u' % statdiff_rd_power7)
      self.fd.write('\n')

      if self.isTerminal:
        self.fd.write('[STAT:%s] ' % self.stat_name_write_power7)
      access_rates_write_power7 = [0 for number in xrange(NUM_BANKS)]
      for bank in range(NUM_BANKS):
        statdiff_wr_power7 = self.stats['stat_wr_power7'][bank].last
        access_rates_write_power7[bank] = statdiff_wr_power7
        self.fd.write(' %u' % statdiff_wr_power7)
      self.fd.write('\n')
      ## power6
      if self.isTerminal:
        self.fd.write('[STAT:%s] ' % self.stat_name_read_power6)
      access_rates_read_power6 = [0 for number in xrange(NUM_BANKS)]
      for bank in range(NUM_BANKS):
        statdiff_rd_power6 = self.stats['stat_rd_power6'][bank].last
        access_rates_read_power6[bank] = statdiff_rd_power6
        self.fd.write(' %u' % statdiff_rd_power6)
      self.fd.write('\n')

      if self.isTerminal:
        self.fd.write('[STAT:%s] ' % self.stat_name_write_power6)
      access_rates_write_power6 = [0 for number in xrange(NUM_BANKS)]
      for bank in range(NUM_BANKS):
        statdiff_wr_power6 = self.stats['stat_wr_power6'][bank].last
        access_rates_write_power6[bank] = statdiff_wr_power6
        self.fd.write(' %u' % statdiff_wr_power6)
      self.fd.write('\n')
      ## power5
      if self.isTerminal:
        self.fd.write('[STAT:%s] ' % self.stat_name_read_power5)
      access_rates_read_power5 = [0 for number in xrange(NUM_BANKS)]
      for bank in range(NUM_BANKS):
        statdiff_rd_power5 = self.stats['stat_rd_power5'][bank].last
        access_rates_read_power5[bank] = statdiff_rd_power5
        self.fd.write(' %u' % statdiff_rd_power5)
      self.fd.write('\n')

      if self.isTerminal:
        self.fd.write('[STAT:%s] ' % self.stat_name_write_power5)
      access_rates_write_power5 = [0 for number in xrange(NUM_BANKS)]
      for bank in range(NUM_BANKS):
        statdiff_wr_power5 = self.stats['stat_wr_power5'][bank].last
        access_rates_write_power5[bank] = statdiff_wr_power5
        self.fd.write(' %u' % statdiff_wr_power5)
      self.fd.write('\n')

      return access_rates_read, access_rates_write, access_rates_read_lowpower, access_rates_write_lowpower,\
              access_rates_read_power9, access_rates_write_power9 ,\
              access_rates_read_power8, access_rates_write_power8 ,\
              access_rates_read_power7, access_rates_write_power7 ,\
              access_rates_read_power6, access_rates_write_power6 ,\
              access_rates_read_power5, access_rates_write_power5 
...
# Multi-dram_mode , you should change here , XJY
  def write_bank_leakage_trace(self, time, time_delta):
    ...
    for bank in range(NUM_BANKS):
      ...
      if bank_mode_trace[bank] == POWER_9:
        leakage = lpm_leakage_power9
      if bank_mode_trace[bank] == POWER_8:
        leakage = lpm_leakage_power8
      if bank_mode_trace[bank] == POWER_7:
        leakage = lpm_leakage_power7
      if bank_mode_trace[bank] == POWER_6:
        leakage = lpm_leakage_power6
      if bank_mode_trace[bank] == POWER_5:
        leakage = lpm_leakage_power5
      # print(bank_mode_trace[bank])
  ...
  def calc_power_trace(self, time, time_delta):
      ...
      ### XJY multi bank-mode ADD 
    if mem_dtm != 'off':
        accesses_read, accesses_write, accesses_read_lowpower, accesses_write_lowpower,\
        accesses_read_power9, accesses_write_power9 ,\
        accesses_read_power8, accesses_write_power8 ,\
        accesses_read_power7, accesses_write_power7 ,\
        accesses_read_power6, accesses_write_power6 ,\
        accesses_read_power5, accesses_write_power5  = self.get_access_rates(time, time_delta)
    if mem_dtm == 'off':
    ...
    for bank in range(NUM_BANKS):
      if mem_dtm != 'off':
        if (bank_mode_trace[bank] == NORMAL_POWER):
            accesses_read[bank] =  accesses_read[bank] + accesses_read_lowpower[bank] + accesses_read_power9[bank] + accesses_read_power8[bank] + accesses_read_power7[bank] + accesses_read_power6[bank]  + accesses_read_power5[bank]
            accesses_write[bank] =  accesses_write[bank] + accesses_write_lowpower[bank]  + accesses_write_power9[bank] + accesses_write_power8[bank] + accesses_write_power7[bank] + accesses_write_power6[bank]  + accesses_write_power5[bank] 
            #accesses_read[bank] =  accesses_read[bank] 
            #accesses_write[bank] =  accesses_write[bank] 
            #
            accesses_read_lowpower[bank] = 0
            accesses_read_power9[bank] = 0
            accesses_read_power8[bank] = 0
            accesses_read_power7[bank] = 0
            accesses_read_power6[bank] = 0
            accesses_read_power5[bank] = 0
            #
            accesses_write_lowpower[bank] = 0
            accesses_write_power9[bank] = 0
            accesses_write_power8[bank] = 0
            accesses_write_power7[bank] = 0
            accesses_write_power6[bank] = 0
            accesses_write_power5[bank] = 0
            #
            num_access = accesses_read[bank] +  accesses_write[bank]
            with open(FILE_3D_ACCESS_PATH, "w") as access_file:
                access_file.write('%d ' % num_access)
            access_file.close()
            #

        if (bank_mode_trace[bank] == LOW_POWER):
            accesses_read_lowpower[bank] =  accesses_read[bank] + accesses_read_lowpower[bank] + accesses_read_power9[bank] + accesses_read_power8[bank] + accesses_read_power7[bank] + accesses_read_power6[bank]  + accesses_read_power5[bank]
            accesses_write_lowpower[bank] =  accesses_write[bank] + accesses_write_lowpower[bank]  + accesses_write_power9[bank] + accesses_write_power8[bank] + accesses_write_power7[bank] + accesses_write_power6[bank]  + accesses_write_power5[bank] 
            #accesses_read_lowpower[bank] =   accesses_read_lowpower[bank] 
            #accesses_write_lowpower[bank] =  accesses_write_lowpower[bank] 
            accesses_read[bank] = 0
            accesses_read_power9[bank] = 0
            accesses_read_power8[bank] = 0
            accesses_read_power7[bank] = 0
            accesses_read_power6[bank] = 0
        ...
        if (bank_mode_trace[bank] == POWER_9):
            accesses_read_power9[bank] =  accesses_read[bank] + accesses_read_lowpower[bank] + accesses_read_power9[bank] + accesses_read_power8[bank] + accesses_read_power7[bank] + accesses_read_power6[bank]  + accesses_read_power5[bank]
            accesses_write_power9[bank] =  accesses_write[bank] + accesses_write_lowpower[bank]  + accesses_write_power9[bank] + accesses_write_power8[bank] + accesses_write_power7[bank] + accesses_write_power6[bank]  + accesses_write_power5[bank] 
            #accesses_read_power9[bank] =   accesses_read_power9[bank] 
            #accesses_write_power9[bank] =   accesses_write_power9[bank] 
            accesses_read[bank] = 0
            accesses_read_lowpower[bank] = 0
            accesses_read_power8[bank] = 0
            accesses_read_power7[bank] = 0
        ...
        if (bank_mode_trace[bank] == POWER_8):
            accesses_read_power8[bank] =  accesses_read[bank] + accesses_read_lowpower[bank] + accesses_read_power9[bank] + accesses_read_power8[bank] + accesses_read_power7[bank] + accesses_read_power6[bank]  + accesses_read_power5[bank]
            accesses_write_power8[bank] =  accesses_write[bank] + accesses_write_lowpower[bank]  + accesses_write_power9[bank] + accesses_write_power8[bank] + accesses_write_power7[bank] + accesses_write_power6[bank]  + accesses_write_power5[bank] 
            #accesses_read_power8[bank] =   accesses_read_power8[bank] 
            #accesses_write_power8[bank] =  accesses_write_power8[bank] 
            accesses_read[bank] = 0
            accesses_read_lowpower[bank] = 0
            accesses_read_power9[bank] = 0
            accesses_read_power7[bank] = 0
        ...
        if (bank_mode_trace[bank] == POWER_7):
            accesses_read_power7[bank] =  accesses_read[bank] + accesses_read_lowpower[bank]  + accesses_read_power9[bank] + accesses_read_power8[bank] + accesses_read_power7[bank] + accesses_read_power6[bank]  + accesses_read_power5[bank]
            accesses_write_power7[bank] =  accesses_write[bank] + accesses_write_lowpower[bank] + accesses_write_power9[bank] + accesses_write_power8[bank] + accesses_write_power7[bank] + accesses_write_power6[bank]  + accesses_write_power5[bank]
            #accesses_read_power7[bank] =  accesses_read_power7[bank] 
            #accesses_write_power7[bank] = accesses_write_power7[bank] 
            accesses_read[bank] = 0
            accesses_read_lowpower[bank] = 0
            accesses_read_power9[bank] = 0
            accesses_read_power8[bank] = 0
        ...
        if (bank_mode_trace[bank] == POWER_6):
            accesses_read_power6[bank] =  accesses_read[bank] + accesses_read_lowpower[bank]  + accesses_read_power9[bank] + accesses_read_power8[bank] + accesses_read_power7[bank] + accesses_read_power6[bank]  + accesses_read_power5[bank]
            accesses_write_power6[bank] =  accesses_write[bank] + accesses_write_lowpower[bank] + accesses_write_power9[bank] + accesses_write_power8[bank] + accesses_write_power7[bank] + accesses_write_power6[bank]  + accesses_write_power5[bank]
            #accesses_read_power6[bank] =  accesses_read_power6[bank]
            #accesses_write_power6[bank] = accesses_write_power6[bank]
            accesses_read[bank] = 0
            accesses_read_lowpower[bank] = 0
            accesses_read_power9[bank] = 0
            accesses_read_power8[bank] = 0
        ...
        if (bank_mode_trace[bank] == POWER_5):
            accesses_read_power5[bank] =  accesses_read[bank] + accesses_read_lowpower[bank]  + accesses_read_power9[bank] + accesses_read_power8[bank] + accesses_read_power7[bank] + accesses_read_power6[bank]  + accesses_read_power5[bank]
            accesses_write_power5[bank] =  accesses_write[bank] + accesses_write_lowpower[bank] + accesses_write_power9[bank] + accesses_write_power8[bank] + accesses_write_power7[bank] + accesses_write_power6[bank]  + accesses_write_power5[bank]
            #accesses_read_power5[bank] =  accesses_read_power5[bank]
            #accesses_write_power5[bank] = accesses_write_power5[bank]
            accesses_read[bank] = 0
            accesses_read_lowpower[bank] = 0
            accesses_read_power9[bank] = 0
            accesses_read_power8[bank] = 0
        ...
        ## There you should know the bank mode diff 
        ## There you should know the bank mode diff 
        ## There you should know the bank mode diff 
        ## There you should know the bank mode diff 
        ## There you should know the bank mode diff 
        ...
        ### XJY multi bank-mode ADD
        ### XJY multi bank-mode ADD
        power9_access    = (accesses_read_power9[bank] * energy_per_read_access + accesses_write_power9[bank] * energy_per_write_access) * lpm_dynamic_power9
        power8_access    = (accesses_read_power8[bank] * energy_per_read_access + accesses_write_power8[bank] * energy_per_write_access) * lpm_dynamic_power8
        power7_access    = (accesses_read_power7[bank] * energy_per_read_access + accesses_write_power7[bank] * energy_per_write_access) * lpm_dynamic_power7
        power6_access    = (accesses_read_power6[bank] * energy_per_read_access + accesses_write_power6[bank] * energy_per_write_access) * lpm_dynamic_power6
        power5_access    = (accesses_read_power5[bank] * energy_per_read_access + accesses_write_power5[bank] * energy_per_write_access) * lpm_dynamic_power5
        ### 
        bank_power_trace[bank] =  (normal_power_access + low_power_access + \
                power9_access + power8_access + \
                power7_access + power6_access + power5_access ) / (timestep*1000) + bank_static_power + avg_refresh_power
        ### XJY multi bank-mode ADD ENDS
        ### XJY multi bank-mode ADD ENDS
